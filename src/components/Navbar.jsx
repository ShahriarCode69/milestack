...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 z-50 mx-auto h-auto w-full p-8">
      <div className="liquid-glass container flex motion-blur-in-[30px] motion-opacity-in-[0%] motion-translate-x-in-[-1%] motion-translate-y-in-[-129%] items-center justify-between px-5 py-3">
      ...
      {isOpen && (
        <div className="liquid-glass mt-4 flex h-auto motion-blur-in-[21px] motion-translate-x-in-[167%] flex-col items-center justify-center gap-16 py-12 motion-duration-[0.4s] md:hidden">
